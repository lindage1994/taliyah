package org.iahsnil.auth.client.service;
...
public interface IAuthService {
     ...
     * @return ResponseBean<?>
     */
    ResponseBean<?> authenticate(String authentication, String url, String method);
     ...
     * @return
     */
    boolean hasPermission(ResponseBean<?> authResult);
